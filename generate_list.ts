...
// Copying necessary types and registry
interface Treasure {
    id: string;
    catalogId: number;
    name: string;
...
const PREFIXES = [
  { name: "ボロボロの", valueMod: 0.5 },
  { name: "普通の", valueMod: 1.0 },
  { name: "少し良い", valueMod: 1.2 },
  { name: "硬い", valueMod: 1.5 },
  { name: "大きな", valueMod: 2.0 },
  { name: "銀の", valueMod: 5.0 },
  { name: "金の", valueMod: 10.0 },
  { name: "伝説の", valueMod: 50.0 },
];
...
const BASE_ITEMS = [
    ...
    { name: "肉", baseVal: 15 },
    { name: "魚", baseVal: 12 },
    { name: "クッキー", baseVal: 20 },
    { name: "ボール", baseVal: 30 },
    { name: "フリスビー", baseVal: 40 },
    { name: "ぬいぐるみ", baseVal: 50 },
    { name: "靴", baseVal: 25 },
    { name: "靴下", baseVal: 10 },
    { name: "手袋", baseVal: 15 },
    { name: "帽子", baseVal: 30 },
    ...
    { name: "ハサミ", baseVal: 30 },
    { name: "カギ", baseVal: 50 },
    { name: "スマホ", baseVal: 600 },
    { name: "カメラ", baseVal: 400 },
    { name: "ラジオ", baseVal: 80 },
    { name: "テレビ", baseVal: 200 },
    { name: "パソコン", baseVal: 800 },
    { name: "電球", baseVal: 10 },
    { name: "電池", baseVal: 5 },
    { name: "車", baseVal: 150 },
    { name: "飛行機", baseVal: 300 },
    { name: "ロケット", baseVal: 1000 },
    { name: "花", baseVal: 20 },
    { name: "キノコ", baseVal: 15 },
    { name: "リンゴ", baseVal: 30 },
    { name: "バナナ", baseVal: 25 },
    { name: "バーガー", baseVal: 60 },
    { name: "ケーキ", baseVal: 80 },
    { name: "アイス", baseVal: 50 }
];
...
const TREASURE_REGISTRY = [...UNIQUE_TREASURES, ...GENERATED_TREASURES].map((item, index) => ({
    catalogId: index + 1,
    value: item.value
}));

const list = TREASURE_REGISTRY.slice(0, 500);

const ids = list.map(t => t.catalogId);
const amounts = list.map(t => BigInt(t.value) * BigInt(10**18));

console.log("IDs:");
console.log(JSON.stringify(ids));
console.log("\nAmounts:");
console.log(JSON.stringify(amounts.map(a => a.toString())));
