...
const tMap: Record<string, { nameEn: string, descEn: string }> = {
  ...
  "ルビー": { nameEn: "Ruby", descEn: "A red gem." },
  "サファイア": { nameEn: "Sapphire", descEn: "A blue gem." },
  "エメラルド": { nameEn: "Emerald", descEn: "A green gem." },
  "ダイヤモンド": { nameEn: "Diamond", descEn: "A transparent gem." },
