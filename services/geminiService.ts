...
const UNIQUE_TREASURES = [
  ...
  { name: "ボロボロの鎖", description: "何かに繋がれていた。", value: 10, icon: "GiChainedShort" },
  ...
  { name: "奇妙な根っこ", description: "魔法薬の材料になるかも。", value: 8, icon: "GiTreeRoots" },
  ...
  { name: "枯れた薬草", description: "効果はなさそう。", value: 4, icon: "GiFallingLeaf" },
  { name: "魔導書の破れ紙", description: "解読できない文字。", value: 20, icon: "GiScrollUnfurled" },
  { name: "壊れた方位磁針", description: "北を指さない。", value: 25, icon: "GiCompass" },
  { name: "鉄くず", description: "溶かせば何かに使える。", value: 10, icon: "GiMetalBar" },
  { name: "割れた瓶", description: "何も入れられない。", value: 8, icon: "GiBrokenBottle" },
  // 21-30
  { name: "動物の骨", description: "何か獣の骨らしい。", value: 15, icon: "GiFishbone" },
  { name: "銅貨", description: "見慣れない国の硬貨。", value: 40, icon: "GiCoins" },
  { name: "銀貨", description: "少し価値のある銀貨。", value: 100, icon: "GiCoins" },
  { name: "金貨", description: "輝きを失っていない金貨。", value: 500, icon: "GiCoins" },
  ...
  { name: "大きなアメジスト", description: "美しい紫の宝石。", value: 300, icon: "GiGemPendant" },
  { name: "トパーズ", description: "黄色く輝く宝石。", value: 250, icon: "GiGemPendant" },
  { name: "サファイア", description: "深い青の宝石。", value: 500, icon: "GiSapphire" },
  { name: "エメラルド", description: "美しい緑の宝石。", value: 550, icon: "GiEmerald" },
  { name: "ルビー", description: "情熱的な赤の宝石。", value: 600, icon: "GiRuby" },
  { name: "ダイヤモンド", description: "最高級の輝き。", value: 1500, icon: "GiDiamondHard" },
  { name: "黒曜石", description: "鋭い断面を持つ火山ガラス。", value: 180, icon: "GiSparkles" },
  { name: "ミスリル鉱石", description: "軽くて丈夫な幻の金属。", value: 800, icon: "GiOreChunk" },
  // 41-50
  { name: "オリハルコン鉱石", description: "最も硬いとされる伝説の金属。", value: 1200, icon: "GiOreChunk" },
  { name: "アダマンタイト", description: "神々が創り出したと言われる鉱石。", value: 1500, icon: "GiOreChunk" },
  ...
  { name: "古代の金貨袋", description: "ずっしりと重い袋。", value: 1000, icon: "GiSwapBag" },
  { name: "精霊のランプ", description: "ほのかに温かい。", value: 450, icon: "GiMagicLamp" },
  { name: "魔法の薬瓶", description: "怪しげな液体が入っている。", value: 220, icon: "GiHealthPotion" },
  { name: "天使の羽根", description: "とても軽く、純白の羽根。", value: 500, icon: "GiAngelWings" },
...
const BASE_ITEMS = [
    ...
    { name: "ルビー", icon: "GiRuby", baseVal: 400, desc: "赤い宝石。" },
    { name: "サファイア", icon: "GiSapphire", baseVal: 400, desc: "青い宝石。" },
