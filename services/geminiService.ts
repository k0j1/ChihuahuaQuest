...
const UNIQUE_TREASURES = [
  ...
  { name: "ボロボロの鎖", description: "何かに繋がれていた。", value: 10, icon: "GiChain" },
  ...
  { name: "枯れた薬草", description: "効果はなさそう。", value: 4, icon: "GiDeadLeaf" },
  { name: "魔導書の破れ紙", description: "解読できない文字。", value: 20, icon: "GiTornPaper" },
  ...
  // 21-30
  { name: "動物の骨", description: "何か獣の骨らしい。", value: 15, icon: "GiBoneBite" },
  ...
  { name: "ミスリル鉱石", description: "軽くて丈夫な幻の金属。", value: 800, icon: "GiOre" },
  // 41-50
  { name: "オリハルコン鉱石", description: "最も硬いとされる伝説の金属。", value: 1200, icon: "GiOre" },
  { name: "アダマンタイト", description: "神々が創り出したと言われる鉱石。", value: 1500, icon: "GiOre" },
  ...
  { name: "精霊のランプ", description: "ほのかに温かい。", value: 450, icon: "GiOilLamp" },
  { name: "魔法の薬瓶", description: "怪しげな液体が入っている。", value: 220, icon: "GiHealthPotion" },
  { name: "天使の羽根", description: "とても軽く、純白の羽根。", value: 500, icon: "GiFeather" },
